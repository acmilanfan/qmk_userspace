...
#define KC_B_MED LT(LAYER_MEDIA, KC_B)
...
#define LAYOUT_LAYER_FUNCTION                                                          \
    ...
    KC_F11, KC_F4, KC_F5, KC_F6, KC_CAPS, ______________HOME_ROW_GASC_R______________, \
    KC_F10, KC_F1, KC_F2, KC_F3, KC_PAUS, _______________DEAD_HALF_ROW_______________, \
                      KC_ESC, KC_ESC, KC_ESC, KC_ESC, KC_ESC
...
#define LAYOUT_LAYER_MOUSE                                                                     \
    _______________DEAD_HALF_ROW_______________, LCTL(LSFT(KC_Z)), LCTL(KC_V), LCTL(KC_C), LCTL(KC_X), LCTL(KC_Z), \
...
#define LAYOUT_LAYER_POINTER                                                                  \
    QK_BOOT, EE_CLR, DPI_RMOD, DPI_MOD, S_D_MOD, S_D_MOD, DPI_MOD, DPI_RMOD, EE_CLR, QK_BOOT, \
    ______________HOME_ROW_GASC_L______________, ______________HOME_ROW_GASC_R______________, \
    _______, DRGSCRL, SNIPING, XXXXXXX, DRG_TOG, DRG_TOG, XXXXXXX, SNIPING, DRGSCRL, _______, \
...
#define LAYOUT_LAYER_SYMBOLS                                                                  \
    ...
    KC_DQUO,  KC_DLR, KC_PERC, KC_CIRC, KC_PLUS, ______________HOME_ROW_GASC_R______________, \
...
combo_t key_combos[] = {
    ...
    [4] = COMBO(combo_copy, LCTL(KC_C)),
    [5] = COMBO(combo_paste, LCTL(KC_V)),
    [6] = COMBO(combo_cut, LCTL(KC_X)),
